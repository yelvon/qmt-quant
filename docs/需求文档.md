...
data:
  db_url: "sqlite:///data/qmt_quant.db"
...
- [ ] 自定义 `CN_A_SHARE` Venue（T+1、费率、整手）
- [ ] NautilusTrader 策略模板 + 3 个内置策略
- [ ] 验证 CLI + 与 VectorBT 结果对比报告
- [ ] 双引擎 pipeline 命令

**里程碑**：同一策略在 VectorBT 与 NautilusTrader 上均可跑通，结果可对比。
